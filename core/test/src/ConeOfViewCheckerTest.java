    ...
    public void upperMiddleConeTest() {
        ...
        for (int i = 0; i < 50; i++) {
            for (int j = 0; j < 50; j++) {
                ...
                assertEquals(i + " " + j, result, upCone.isContainPoint(center, new Vector2(i, j)));
            }
        }
    }
    ...
    public void rightMiddleConeTest() {
        ...
        for (int i = 0; i < 50; i++) {
            for (int j = 0; j < 50; j++) {
                ...
                assertEquals(i + " " + j, result, rightCone.isContainPoint(center, new Vector2(i, j)));
            }
        }
    }
    ...
    public void downMiddleConeTest() {
        ...
        for (int i = 0; i < 50; i++) {
            for (int j = 0; j < 50; j++) {
                ...
                assertEquals(i + " " + j, result, downCone.isContainPoint(center, new Vector2(i, j)));
            }
        }
    }
    ...
    public void leftMiddleConeTest() {
        ...
        for (int i = 0; i < 50; i++) {
            for (int j = 0; j < 50; j++) {
                ...
                assertEquals(i + " " + j, result, leftCone.isContainPoint(center, new Vector2(i, j)));
            }
        }
    }
}
